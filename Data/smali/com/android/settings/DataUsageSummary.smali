...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/DataUsageSummary$MyHandler;,
        Lcom/android/settings/DataUsageSummary$AirplaneContentObserver;,
...
.field private mAirplaneObserver:Lcom/android/settings/DataUsageSummary$AirplaneContentObserver;
...
.field private mHandler:Lcom/android/settings/DataUsageSummary$MyHandler;
...
.field private mUpdateUiForAirplaneModeOff:Z
...
.method public constructor <init>()V
    ...
    .line 288
    iput-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->mUpdateUiForAirplaneModeOff:Z

    .line 289
    iput-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->mIsAirplaneModeOn:Z
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$000(Lcom/android/settings/DataUsageSummary;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/DataUsageSummary;

    .prologue
    .line 174
    iget-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->mUpdateUiForAirplaneModeOff:Z
...
.method static synthetic access$002(Lcom/android/settings/DataUsageSummary;Z)Z
    ...
    .prologue
    .line 174
    iput-boolean p1, p0, Lcom/android/settings/DataUsageSummary;->mUpdateUiForAirplaneModeOff:Z

    return p1
.end method

.method static synthetic access$100(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/DataUsageSummary$MyHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/DataUsageSummary;

    .prologue
    .line 174
    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->mHandler:Lcom/android/settings/DataUsageSummary$MyHandler;
...
.method static synthetic access$2702(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/DataUsageSummary$AppItem;)Lcom/android/settings/DataUsageSummary$AppItem;
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/DataUsageSummary;
...
.method static synthetic access$2800(Lcom/android/settings/DataUsageSummary;)Landroid/net/NetworkTemplate;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/DataUsageSummary;
...
.method static synthetic access$2900(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/NetworkPolicyEditor;
    .locals 1
    .param p0, "x0"    # Lcom/android/settings/DataUsageSummary;
...
.method static synthetic access$3102(Lcom/android/settings/DataUsageSummary;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/DataUsageSummary;
    .param p1, "x1"    # Z
...
.method static synthetic access$3200(Landroid/content/Context;)Z
    .locals 1
    .param p0, "x0"    # Landroid/content/Context;

    .prologue
    .line 174
    invoke-static {p0}, Lcom/android/settings/DataUsageSummary;->isAirplaneModeOn(Landroid/content/Context;)Z
...
.method static synthetic access$3300(Lcom/android/settings/DataUsageSummary;Landroid/os/Message;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/settings/DataUsageSummary;
    ...
    .prologue
    .line 174
    invoke-direct {p0, p1}, Lcom/android/settings/DataUsageSummary;->handleMessage(Landroid/os/Message;)V
...
.method private handleMessage(Landroid/os/Message;)V
    ...
    .line 2617
    iput-boolean v3, p0, Lcom/android/settings/DataUsageSummary;->mUpdateUiForAirplaneModeOff:Z
...
.method private updatePolicy(Z)V
    ...
    const-string v1, "mDataEnabled.setEnabled(true)"
    ...
    invoke-virtual {v0, v4}, Lcom/android/settings/widget/ChartDataUsageView;->bindNetworkPolicy(Landroid/net/NetworkPolicy;)V
    ...
    const-string v1, "mDataEnabled.setEnabled(false)"
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 326
    new-instance v2, Lcom/android/settings/DataUsageSummary$MyHandler;

    invoke-direct {v2, p0}, Lcom/android/settings/DataUsageSummary$MyHandler;-><init>(Lcom/android/settings/DataUsageSummary;)V

    iput-object v2, p0, Lcom/android/settings/DataUsageSummary;->mHandler:Lcom/android/settings/DataUsageSummary$MyHandler;

    .line 327
    new-instance v2, Lcom/android/settings/DataUsageSummary$AirplaneContentObserver;

    invoke-direct {v2, p0, v0}, Lcom/android/settings/DataUsageSummary$AirplaneContentObserver;-><init>(Lcom/android/settings/DataUsageSummary;Landroid/content/Context;)V

    iput-object v2, p0, Lcom/android/settings/DataUsageSummary;->mAirplaneObserver:Lcom/android/settings/DataUsageSummary$AirplaneContentObserver;
...
.method public onDestroy()V
    ...
    invoke-virtual {v0, v3}, Lcom/android/settings/DataUsageSummary$MyHandler;->removeCallbacksAndMessages(Ljava/lang/Object;)V
...
.method public onPause()V
    ...
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->mAirplaneObserver:Lcom/android/settings/DataUsageSummary$AirplaneContentObserver;
    ...
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    iget-boolean v11, p0, Lcom/android/settings/DataUsageSummary;->mIsAirplaneModeOn:Z
...
.method public onResume()V
    ...
    invoke-static {v2}, Lcom/android/settings/DataUsageSummary;->computeTabFromIntent(Landroid/content/Intent;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mAirplaneObserver:Lcom/android/settings/DataUsageSummary$AirplaneContentObserver;
    ...
    .line 473
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 475
    invoke-static {v0}, Lcom/android/settings/DataUsageSummary;->isAirplaneModeOn(Landroid/content/Context;)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/settings/DataUsageSummary;->mIsAirplaneModeOn:Z
    ...
    .line 486
    new-instance v3, Lcom/android/settings/DataUsageSummary$2;

    invoke-direct {v3, p0}, Lcom/android/settings/DataUsageSummary$2;-><init>(Lcom/android/settings/DataUsageSummary;)V
    ...
    invoke-virtual {v3, v4, v5}, Lcom/android/settings/DataUsageSummary$2;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
